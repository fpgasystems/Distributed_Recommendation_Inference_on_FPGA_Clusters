...
void recvDataTransform(hls::stream<ap_uint<512> > & s_data_in, hls::stream<ap_uint<512> > & s_feature_in_1, hls::stream<ap_uint<512> > & s_feature_in_2, hls::stream<ap_uint<512> > & s_result1_all);
...
//template<>
//void matmul_PE_UNROLL8<HIDDEN_SIZE1, INDEX_EVEN>(
//    hls::stream<W_TYPE>& s_feature_PE_0,
//    hls::stream<W_TYPE>& s_feature_PE_1,
//    hls::stream<D_TYPE>& s_result_PE);
//
//template<>
//void matmul_PE_UNROLL8<HIDDEN_SIZE1, INDEX_ODD>(
//    hls::stream<W_TYPE>& s_feature_PE_0,
//    hls::stream<W_TYPE>& s_feature_PE_1,
//    hls::stream<D_TYPE>& s_result_PE);
...
void dataTransform(hls::stream<ap_uint<512> > & s_result_all, hls::stream<ap_uint<512> > & s_result_partial, hls::stream<ap_uint<512> > & s_data_out);
...
#pragma HLS inline off
    ...
    //W_TYPE feature_local_even[HIDDEN_SIZE1 / INTS_PER_W / 2];
    //W_TYPE feature_local_odd[HIDDEN_SIZE1 / INTS_PER_W / 2];
...
//#pragma HLS resource variable=feature_local core=RAM_T2P_URAM
    ...
    for (int item = 0; item < BATCH_NUM * BATCH_SIZE; item++) {
        ...
        //    feature_local[4*i]   = s_feature_PE_0.read();
        //    feature_local[4*i+1] = s_feature_PE_1.read();
        //    feature_local[4*i+2] = s_feature_PE_2.read();
        //    feature_local[4*i+3]  = s_feature_PE_3.read();
        //}
        // compute and write
...
void dataTransform(hls::stream<ap_uint<512> > & s_result_all, hls::stream<ap_uint<512> > & s_result_partial, hls::stream<ap_uint<512> > & s_data_out){
    ...
    for (int item = 0; item < BATCH_NUM * BATCH_SIZE; item++) {
        for (int i = 0; i < 64; i++){
            #pragma HLS pipeline II=1
            s_data_out.write(s_result_all.read());
        }
        for (int i = 0; i < 20; i++){
            #pragma HLS pipeline II=1
            s_data_out.write(s_result_partial.read());
        }
