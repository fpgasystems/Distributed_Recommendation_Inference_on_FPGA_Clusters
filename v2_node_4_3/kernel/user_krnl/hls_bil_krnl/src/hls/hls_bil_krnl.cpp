...
void initialize_basePort(
    int basePort_recv_1, 
    int basePort_recv_2, 
    ap_uint<16>* basePort)
{
    basePort[0] = basePort_recv_1;
    basePort[1] = basePort_recv_2;
}
...
#pragma HLS INTERFACE s_axilite port=basePort_recv_1 bundle = control
#pragma HLS INTERFACE s_axilite port=expectedRxPkgCnt_1 bundle = control
#pragma HLS INTERFACE s_axilite port=basePort_recv_2 bundle = control
#pragma HLS INTERFACE s_axilite port=expectedRxPkgCnt_2 bundle = control
// Sending data
...
static hls::stream<ap_uint<512> >    s_data_in_1;
#pragma HLS STREAM variable=s_data_in_1 depth=16
static hls::stream<ap_uint<512> >    s_data_in_2;
#pragma HLS STREAM variable=s_data_in_2 depth=512
...
#pragma HLS STREAM variable=stage_status depth=2
    ...
    uint32_t expectedRxByteCnt_1 = expectedRxPkgCnt_1 * 1024;
    uint32_t expectedRxByteCnt_2 = expectedRxPkgCnt_2 * 1024;

    initialize_basePort(basePort_recv_1, basePort_recv_2, basePort);

#pragma HLS dataflow

    listenPorts (basePort, useConn_recv, m_axis_tcp_listen_port, 
    ...
    consumeW(s_data_in_1, expectedRxPkgCnt_1);

///////////////////////// Compute ////////////////////////////////////////////
    //recvDataTransform(s_data_in_2, s_result1_all, s_result2_node3);
    //recvDataTransform_2(s_data_in_2,s_feature3_in_0,s_feature3_in_1, s_result3_node3);
    replicate_feature_in_4(s_data_in_2, s_feature3_in_0_0, s_feature3_in_1_0, s_feature3_in_2_0, s_feature3_in_3_0);
