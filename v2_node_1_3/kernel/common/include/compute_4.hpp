...
void int_to_wide(
    ...
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide);

void gather_embeddings(
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM0, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM1, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM2, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM3, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM4, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM5, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM6, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM7, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM8, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM9, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM10, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM11, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM12, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM13, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM14, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM15, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM16, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM17, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM18, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM19, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM20, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM21, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM22, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM23, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM24, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM25, 
    hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM26, hls::stream<ap_uint<512> >& s_embedding_buffer_wide_HBM27, 
...
void matmul_PE_UNROLL8(
    ...
    hls::stream<W_TYPE>& s_feature_PE_2,
    hls::stream<W_TYPE>& s_feature_PE_3,
...
const int depth_s_embedding_buffer_wide_HBM0 = VECTOR_SIZE_HBM_BANK_0 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM1 = VECTOR_SIZE_HBM_BANK_1 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM2 = VECTOR_SIZE_HBM_BANK_2 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM3 = VECTOR_SIZE_HBM_BANK_3 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM4 = VECTOR_SIZE_HBM_BANK_4 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM5 = VECTOR_SIZE_HBM_BANK_5 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM6 = VECTOR_SIZE_HBM_BANK_6 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM7 = VECTOR_SIZE_HBM_BANK_7 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM8 = VECTOR_SIZE_HBM_BANK_8 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM9 = VECTOR_SIZE_HBM_BANK_9 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM10 = VECTOR_SIZE_HBM_BANK_10 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM11 = VECTOR_SIZE_HBM_BANK_11 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM12 = VECTOR_SIZE_HBM_BANK_12 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM13 = VECTOR_SIZE_HBM_BANK_13 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM14 = VECTOR_SIZE_HBM_BANK_14 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM15 = VECTOR_SIZE_HBM_BANK_15 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM16 = VECTOR_SIZE_HBM_BANK_16 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM17 = VECTOR_SIZE_HBM_BANK_17 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM18 = VECTOR_SIZE_HBM_BANK_18 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM19 = VECTOR_SIZE_HBM_BANK_19 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM20 = VECTOR_SIZE_HBM_BANK_20 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM21 = VECTOR_SIZE_HBM_BANK_21 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM22 = VECTOR_SIZE_HBM_BANK_22 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM23 = VECTOR_SIZE_HBM_BANK_23 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM24 = VECTOR_SIZE_HBM_BANK_24 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM25 = VECTOR_SIZE_HBM_BANK_25 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM26 = VECTOR_SIZE_HBM_BANK_26 * FIFO_BATCH_SIZE / 16;
const int depth_s_embedding_buffer_wide_HBM27 = VECTOR_SIZE_HBM_BANK_27 * FIFO_BATCH_SIZE / 16;
...
#pragma HLS inline off
    ...
    for (int i = 0; i < BATCH_NUM * BATCH_SIZE; i++) {
        ...
        for (int j = 0; j < VECTOR_LENGTH / INTS_PER_W / 4; j++) {
            ...
            reg.range(287, 256) = s_embedding_buffer.read();
            reg.range(319, 288) = s_embedding_buffer.read();
            reg.range(351, 320) = s_embedding_buffer.read();
            reg.range(383, 352) = s_embedding_buffer.read();

            reg.range(415, 384) = s_embedding_buffer.read();
            reg.range(447, 416) = s_embedding_buffer.read();
            reg.range(479, 448) = s_embedding_buffer.read();
            reg.range(511, 480) = s_embedding_buffer.read();
...
#pragma HLS inline off
    ...
    for (int item = 0; item < BATCH_NUM * BATCH_SIZE; item++) {
        ...
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_1 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM1.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_2 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM2.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_3 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM3.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_4 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM4.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_5 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM5.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_6 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM6.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_7 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM7.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_8 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM8.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_9 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM9.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_10 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM10.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_11 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM11.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_12 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM12.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_13 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM13.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_14 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM14.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_15 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM15.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_16 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM16.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_17 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM17.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_18 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM18.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_19 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM19.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_20 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM20.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_21 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM21.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_22 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM22.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_23 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM23.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_24 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM24.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_25 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM25.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_26 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
            s_feature_in.write(s_embedding_buffer_wide_HBM26.read());
        }
        for (int i = 0; i < VECTOR_SIZE_HBM_BANK_27 / INTS_PER_W / 4; i++) {
            #pragma HLS pipeline II=1
...
#pragma HLS inline off
    ...
    W_TYPE feature_local_even[INPUT_SIZE / INTS_PER_W / 2];
    W_TYPE feature_local_odd[INPUT_SIZE / INTS_PER_W / 2];
    ...
    for (int item = 0; item < BATCH_NUM * BATCH_SIZE; item++) {
        ...
        for (int result_idx = 0; result_idx < ROW_PER_PE1; result_idx++) {
            ...
            for (int d = 0; d < INPUT_SIZE / INTS_PER_W / 2; d++) {
                ...
                W_TYPE reg_f_0 = feature_local_even[d];
                W_TYPE reg_f_1 = feature_local_odd[d];
...
#pragma HLS inline off
    ...
    W_TYPE feature_local_odd[INPUT_SIZE / INTS_PER_W / 2];
#pragma HLS resource variable=weights_transpose_local core=RAM_2P_URAM
#pragma HLS resource variable=feature_local_even core=RAM_T2P_URAM
#pragma HLS resource variable=feature_local_odd core=RAM_T2P_URAM
