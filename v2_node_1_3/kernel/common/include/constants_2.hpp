...
typedef int D_TYPE;
typedef ap_int<256> W_TYPE;  // weights / feature width
// typedef ap_int<256> FIFO_TYPE;  // stream width

#define INTS_PER_W 8 // 256 bit = 8 x 32 bit int
// #define INTS_PER_FIFO 8

#define INPUT_SIZE 896

#define HIDDEN_SIZE1_PARTIAL 400
...
#define ROW_PER_PE1 (HIDDEN_SIZE1_PARTIAL / PE_NUM1) // 400 / 200 = 2
